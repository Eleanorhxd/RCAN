...
def parse_agrs():
    ...
    parser.add_argument('--image_dir', type=str, default=r'E:\hxd\mimic_cxr\images',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default=r'E:\hxd\mimic_cxr\annotation.json',
                        help='the path to the directory containing the data.')
    ...
    parser.add_argument('--load', type=str, default=r'C:\Users\admin\Desktop\model_best.pth', help='whether to load the pre-trained model.')
