...
def parse_agrs():
    ...
    parser.add_argument('--save_dir', type=str, default=r'/root/autodl-tmp/WCL/results/iu_xray/model_best.pth', help='the patch to save the models.')
    ...
    parser.add_argument('--load', type=str, default=r'/root/autodl-tmp/WCL/results/iu_xray/model_best.pth', help='whether to load the pre-trained model.')
