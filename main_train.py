...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default=r'E:\hxd\R2GenCMN-main\data\iu_xray\images',
                        help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default=r'E:\hxd\R2GenCMN-main\data\iu_xray\annotation.json',
                        help='the path to the directory containing the data.')

    #
    # parser.add_argument('--image_dir', type=str, default=r'/root/autodl-tmp/mimic_cxr/images',
    #                     help='the path to the directory containing the data.')
    # parser.add_argument('--ann_path', type=str, default=r'/root/autodl-tmp/annotation90.json',
    #                     help='the path to the directory containing the data.')
    ...
    parser.add_argument('--threshold', type=int, default=3, help='the cut off frequency for the words.') # 3
    ...
    parser.add_argument('--save_dir', type=str, default='results/iu_xray10', help='the patch to save the models.')
    ...
    parser.add_argument('--lr_ve', type=float, default=5e-5, help='the learning rate for the visual extractor.') #5e-5(最好), 1e-4
    parser.add_argument('--lr_ed', type=float, default=7e-4, help='the learning rate for the remaining parameters.') #7e-4(最好) 5e-4
    ...
    # Others
    parser.add_argument('--seed', type=int, default=7588, help='.') # 9233 7580 7588(最好)
